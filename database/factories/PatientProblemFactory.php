...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\PatientProblem>
 */
class PatientProblemFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'age' => $this->faker->numberBetween(1, 100), // Generates a random age between 1 and 100
