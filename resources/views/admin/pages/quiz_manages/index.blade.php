        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex">
                        <a href="{{ route('quizManage.create') }}" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="right" title="Add Quiz"><i class="mdi mdi-library-plus"></i> Add Quiz set</a>
                    </div>
                </div>
                ...
                <tr class="text-center">
                    ...
                    <td>
                        <div class="action-buttons">
                                        <a href="{{ route('quizManage.edit', $quiz->id) }}" class="btn btn-sm btn-info me-2" data-toggle="tooltip" data-placement="right" title="Edit Question"><i class="mdi mdi-grease-pencil"></i></a>
