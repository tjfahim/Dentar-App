 ...
 @if ($errors->any())
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{ route('quizManage.indexwithuser') }}" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="right" title="List Quizzes"><i class="mdi mdi-step-backward"></i>List Quizzes</a>
                    </div>
                    <div class="row mt-5">
                        <div class="mt-2">
                            <label for="name">Quiz Name</label>
                            <input type="text" name="name" class="form-control border-info" value="{{ old('name', $quiz->name) }}" placeholder="Enter Quiz Name" required>
                            @error('name')
                        ...
                        <div class="mt-2">
                            ...
                            <textarea name="description" class="form-control border-info" placeholder="Enter Description">{{ old('description', $quiz->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mt-2">
                            ...
                            <input type="datetime-local" name="start_time" class="form-control border-info" value="{{ old('start_time', $quiz->start_time) }}" required>
                            @error('start_time')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mt-2">
                            ...
                            <input type="datetime-local" name="end_time" class="form-control border-info" value="{{ old('end_time', $quiz->end_time) }}" required>
                            @error('end_time')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mt-2">
                            ...
                            <select id="status" name="status" class="form-control border-info">
                                <option value="0" {{ old('status', $quiz->status ) == 0 ? 'selected' : '' }}>Inactive</option>
                ...
                <div class="table-responsive pt-3">
                    ...
                    <div class="row mb-4">
                            <div class="col-md-4">
                                ...
                                {{-- <select id="districtFilter" class="form-select border-secondary">
                            ...
                            <div class="col-md-4">
                                <label for="hospitalFilter" class="form-label fw-bold">Filter by Hospital</label>
                                ...
                                <td class="action d-flex justify-content-center align-items-center">
                                  ...
                                  <td style="text-align: center;">
                                    <input type="checkbox"
                                       ...
                                       {{ in_array($doctor->id, json_decode($quiz->user ?? '[]')) ? 'checked' : '' }}>
                                </td>
                            </tr>
                            @empty
                            <tr class="text-center">
...
<script>
    document.addEventListener('DOMContentLoaded', function(){
        ...
        form.addEventListener('submit', function(e){
            ...
            const updateQuizUrl = "{{ route('quizManage.editWithUserUpdate', $quiz->id) }}";

            console.log(updateQuizUrl)
