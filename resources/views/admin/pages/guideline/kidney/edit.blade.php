...
<div class="row mt-4">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Edit Kidney Guide</h4>
                <form action="{{ route('kidney.update', $guideline->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <button type="submit" class="btn btn-primary mt-3">Update Kidney Guide</button>
                    <a href="{{ route('kidney.index') }}" class="btn btn-secondary mt-3">Cancel</a>
                </form>
            </div>
        </div>
    </div>
