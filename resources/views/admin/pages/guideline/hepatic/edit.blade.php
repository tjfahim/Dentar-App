...
<div class="row mt-4">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Edit Hepatic Care Guide</h4>
                <form action="{{ route('hepatic.update', $guide->id) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    ...
                    <button type="submit" class="btn btn-primary mt-3">Update Hepatic Care Guide</button>
                    <a href="{{ route('hepatic.index') }}" class="btn btn-secondary mt-3">Cancel</a>
                </form>
            </div>
        </div>
    </div>
