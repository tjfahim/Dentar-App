        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <h4 class="card-title">Parenting Mother Guide Lists</h4>
                    <div class="d-flex">
                        <button type="button" class="btn btn-outline-info btn-sm btn-icon-text mx-1" onclick="printTable()">
                            <i class="mdi mdi-printer"></i>
                            Print
                        </button>
                        <a href="{{ route('mother.create') }}" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="right" title="Add Parenting Mother Guide">
                            <i class="mdi mdi-library-plus"></i> Add Parenting Mother Guide
                        </a>
                    </div>
                </div>
                        ...
                        <tbody id="parentingMotherGuideTableBody">
                            ...
                            <tr class="text-center">
                                ...
                                <td class="action d-flex justify-content-center align-items-center">
                                    <a href="{{ route('mother.edit', $guideline->id) }}" class="btn btn-sm btn-info me-2" data-toggle="tooltip" data-placement="right" title="Edit Parenting Mother Guide">
                                    ...
                                    <form action="{{ route('mother.destroy', $guideline->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete?')" class="mb-0">
                                        @method('DELETE')
                                        @csrf
                                        <button type="submit" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="right" title="Delete Parenting Mother Guide">
                            ...
                            @empty
                            <tr class="text-center">
                                <td colspan="6">No parenting mother guides found</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
