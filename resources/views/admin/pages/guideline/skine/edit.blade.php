...
<div class="row mt-4">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Edit Skin Care Guide</h4>
                <form action="{{ route('skine.update', $guide->id) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    ...
                    <button type="submit" class="btn btn-primary mt-3">Update Skin Care Guide</button>
                    <a href="{{ route('skine.index') }}" class="btn btn-secondary mt-3">Cancel</a>
                </form>
            </div>
        </div>
    </div>
